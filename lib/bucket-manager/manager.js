...
function BucketManager() {
  ...
  */
  this.findAllObjects = function(params, callback) {
    if(!params)
      MooseError.getInstance(new TypeError(util.getParamErr('findAllObjects','params')));
    if(util.isCallbackMissed(callback))
        MooseError.getInstance(new TypeError(util.getParamErr('findAllObjects','callback')));
  ...
  */
  this.sendFileObject = function(fileName, params, callback) {
    if(!fileName)
      MooseError.getInstance(new TypeError(util.getParamErr('sendFileObject','fileName')));
    if(!params)
      MooseError.getInstance(new TypeError(util.getParamErr('sendFileObject','params')));
    if(util.isCallbackMissed(callback))
      MooseError.getInstance(new TypeError(util.getParamErr('sendFileObject','callback')));
  ...
  */
  this.createBucket = function(params, callback) {
    if(!params)
      MooseError.getInstance(new TypeError(util.getParamErr('createBucket','params')));
    if(util.isCallbackMissed(callback))
      MooseError.getInstance(new TypeError(util.getParamErr('createBucket','callback')));
  ...
  */
  this.deleteBucket = function(params, callback) {
    if(!params)
      MooseError.getInstance(new TypeError(util.getParamErr('deleteBucket','params')));
    if(util.isCallbackMissed(callback))
      MooseError.getInstance(new TypeError(util.getParamErr('deleteBucket','callback')));
  ...
  */
  this.sendObject = function(params, callback) {
    if(!params)
      MooseError.getInstance(new TypeError(util.getParamErr('sendObject','params')));
    if(util.isCallbackMissed(callback))
      MooseError.getInstance(new TypeError(util.getParamErr('sendObject','callback')));
  ...
  * @param {Function} callback - the callback function to call after treatment
  */
  this.deleteObjects = function(params, callback) {
    if(!params)
      MooseError.getInstance(new TypeError(util.getParamErr('deleteObjects','params')));
    if(util.isCallbackMissed(callback))
      MooseError.getInstance(new TypeError(util.getParamErr('deleteObjects','callback')));
